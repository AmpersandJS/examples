...
new Moonboots({
    moonboots: {
        jsFileName: 'modal-dialog-example',
        cssFileName: 'modal-dialog-example',
...
console.log('Modal Dialog Example is running at: http://localhost:' + config.http.port + ' Yep. That\'s pretty awesome.');
